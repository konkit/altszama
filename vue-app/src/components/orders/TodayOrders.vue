      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col">
            ...
            <a href="#/orders/create" class="btn btn-success pull-right">Create new order &nbsp;<i class="fa fa-plus" aria-hidden="true"></i></a>
          ...
          <div class="col">
            ...
            <div v-if="this.results.createdOrders.length > 0">
              <table class="table table-hover">
                ...
                <tbody>
                  <tr v-on:click="goToOrder(order.id)" v-for="order in this.results.createdOrders" v-bind:key="order.id" class="pointer">
          ...
          <div class="col">
            ...
            <div v-if="this.results.orderingOrders.length > 0">
              <table class="table table-hover">
                ...
                <tbody>
                  <tr v-on:click="goToOrder(order.id)" v-for="order in this.results.orderingOrders" v-bind:key="order.id" class="pointer">
                    <td>{{order.restaurant.name}}</td>
                    <td>{{order.orderCreator.username}}</td>
                  </tr>
                </tbody>
          ...
          <div class="col">
            ...
            <div v-if="this.results.orderedOrders.length > 0">
              <table class="table table-hover">
                ...
                <tbody>
                  <tr @click="goToOrder(order.id)" v-for="order in this.results.orderedOrders" v-bind:key="order.id" class="pointer">
                    <td>{{order.restaurant.name}}</td>
                    <td>{{order.orderCreator.username}}</td>
                  </tr>
                </tbody>
          ...
          <div class="col">
            ...
            <div v-if="this.results.deliveredOrders.length > 0">
              <table class="table table-hover">
                ...
                <tbody>
                  <tr v-on:click="goToOrder(order.id)" v-for="order in this.results.deliveredOrders" v-bind:key="order.id" class="pointer">
                    <td>{{order.restaurant.name}}</td>
                    <td>{{order.orderCreator.username}}</td>
                  </tr>
                </tbody>
