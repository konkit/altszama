...
export default {
    ...
    mutations: (_a = {},
        ...
        _a[SET_INITIAL_CREATED_ORDER_ENTRY] = function (state, _a) {
            var orderId = _a.orderId, dishId = _a.dishId;
        ...
        _a[SET_INITIAL_EDITED_ORDER_ENTRY] = function (state, _a) {
            var orderId = _a.orderId, dishEntry = _a.dishEntry;
            state.orderId = orderId;
        ...
        _a[SET_SIDE_DISH] = function (state, _a) {
            var sdIndex = _a.sdIndex, newValue = _a.newValue;
...
//# sourceMappingURL=ModifyOrderEntryState.js.map