...
export const OrderControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        setAsOrdered(orderId: string, options: any = {}): FetchArgs {
            // verify required parameter 'orderId' is not null or undefined
            if (orderId === null || orderId === undefined) {
...
export const OrderControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        setAsOrdered(orderId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = OrderControllerApiFetchParamCreator(configuration).setAsOrdered(orderId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const OrderControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        setAsOrdered(orderId: string, options?: any) {
            return OrderControllerApiFp(configuration).setAsOrdered(orderId, options)(fetch, basePath);
        },
        /**
         * 
         * @param {string} orderId 
...
export class OrderControllerApi extends BaseAPI {
     ...
     * @memberof OrderControllerApi
     */
    public setAsOrdered(orderId: string, options?: any) {
        return OrderControllerApiFp(this.configuration).setAsOrdered(orderId, options)(this.fetch, this.basePath);
    }
