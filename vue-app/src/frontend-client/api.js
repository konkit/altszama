...
export var OrderControllerApiFetchParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        setAsOrdered: function (orderId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'orderId' is not null or undefined
            if (orderId === null || orderId === undefined) {
...
export var OrderControllerApiFp = function (configuration) {
    return {
         ...
         */
        setAsOrdered: function (orderId, options) {
            var localVarFetchArgs = OrderControllerApiFetchParamCreator(configuration).setAsOrdered(orderId, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
...
var OrderControllerApi = /** @class */ (function (_super) {
     ...
     * @memberof OrderControllerApi
     */
    OrderControllerApi.prototype.setAsOrdered = function (orderId, options) {
