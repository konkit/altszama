...
export var showRestaurantModule = {
  ...
  actions:
    ...
    (_b[FETCH_RESTAURANT_ACTION] = function(_a, _b) {
      ...
      const restaurantId = _b.restaurantId;
      ...
      connector
        ...
        .then(function(response) {
          ...
          document.title =
            "Restaurant " + state.restaurant.name + " | Alt Szama";
        })
    ...
    (_b[DELETE_RESTAURANT_ACTION] = function(_a, _b) {
      const state = _a.state,
        rootState = _a.rootState;
      const restaurantId = _b.restaurantId,
        errorsComponent = _b.errorsComponent;
      const connector = new DishesApiConnector(rootState);
      connector
        .deleteRestaurant(restaurantId)
        .then(function(response) {
          return router.push({ path: "/restaurants" });
        })
        .catch(function(errResponse) {
          return ApiConnector.handleError(errResponse);
        });
    ...
    (_b[DELETE_DISH_ACTION] = function(_a, _b) {
      ...
      connector
        ...
        .then(function(successResponse) {
          _this.dispatch("showRestaurant/" + FETCH_RESTAURANT_ACTION, {
