...
@Component({
    ...
    standalone: true,
    imports: [MatCardModule, OrderDataSummaryComponent, PriceSummaryCardsComponent, PaymentOptionsSummaryCardsComponent, MatExpansionModule, PriceSummaryComponent, PaymentOptionsSummaryComponent, NgIf]
})
